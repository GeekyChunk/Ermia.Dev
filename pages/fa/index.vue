...
const skills = [
    { name: "جنگو", color: "green", rate: "great" },
    { name: "ری اکت", color: "blue", rate: "great" },
    { name: "ویو جی اس", color: "teal", rate: "fluent" },
    { name: "لاراول", color: "amber", rate: "verygood" },
    { name: "تیلویند", color: "blue", rate: "fluent" },
    { name: "بوت استرپ", color: "purple", rate: "fluent" },
];

const sec_skills = [
    { name: "داکر", color: "blue", rate: "great" },
    { name: "لینوکس", color: "yellow", rate: "great" },
    { name: "گیت", color: "rose", rate: "verygood" },
    { name: "انجین ایکس", color: "green", rate: "verygood" },
    { name: "پستگرس", color: "blue", rate: "good" },
    { name: "ردیس", color: "rose", rate: "fluent" },
]
...
<template>
        ...
        <div id="header" class="relative w-full px-2 py-14 bg-slate-200 flex justify-center shadow-md">
            ...
            <div class="z-50 w-full max-w-2xl flex flex-col sm:flex-row justify-center items-center sm:items-stretch gap-6">
                ...
                <div class="flex-grow flex flex-col gap-4 justify-center">
                    ...
                    <h3 class="text-center md:text-start text-3xl">توسعه دهنده وب و دوآپس</h3>
                    <div class="w-full">
                        <div class="flex justify-center md:justify-start">
                            <FaTabs @navigate="onNaviagate" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div dir="rtl" class="font-fa w-full px-4 py-8 flex justify-center">
        <div class="w-full max-w-4xl">
            <div id="bio" class="pt-12 pb-24">
                <h1 class="text-4xl font-semibold text-center sm:text-start">ℹ️ <span class="italic">بیوگرافی</span></h1>

                <div class="pt-6">
                    <blockquote dir="rtl" class="relative mt-1">
            ...
            <div id="skills" class="py-8">
                <h1 class="text-center sm:text-start text-4xl font-semibold">⚙️ <span class="underline">مهارت ها</span></h1>
                <FaSkillSection :sec_skills="sec_skills" :skills="skills" />
            </div>
            ...
            <div id="contact" class="py-10">
                ...
                <div class="py-8 flex flex-wrap justify-center gap-4">
                    ...
                    <FaSocialLink label="تلگرام" color="purple" name="Telegram" avatar="/logos/telegram.png" :islink="true" link="https://MakaveliDon619.t.me" />
                    <FaSocialLink label="استک اورفلو" color="orange" name="StackOverflow" avatar="/logos/stack.png" :islink="true" link="https://stackoverflow.com/users/15701892/" />
                </div>
            </div>
        </div>
    </div>
