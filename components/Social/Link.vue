    ...
    <div :id="props.name" class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto">
        <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
            ...
            <div class="p-4 overflow-y-auto">
                ...
                <label for="input-label" class="block text-sm font-medium mb-2">{{ props.name }}</label>
                <input readonly :value="props.link" class="py-3 font-medium px-4 block w-full border-2 border-gray-200 rounded-md text-sm focus:outline-none focus:border-blue-500 focus:ring-blue-500" placeholder="you@site.com" autofocus>
            </div>
